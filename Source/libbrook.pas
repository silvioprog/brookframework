...
var
  ...
  bk_is_post: function(const method: Pcchar): cbool; cdecl;
...
{$ENDIF}
    ...
    bk_is_post := GetProcAddress(GBkLibHandle, 'bk_is_post');
    ...
    bk_httpreq_uploading := GetProcAddress(GBkLibHandle, 'bk_httpreq_uploading');
