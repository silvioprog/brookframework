...
var
  ...
  sg_httpsrv_set_max_payld_size: function(srv: Psg_httpsrv;
    size: csize_t): cint; cdecl;
  sg_httpsrv_max_payld_size: function(srv: Psg_httpsrv): csize_t; cdecl;
  sg_httpsrv_set_max_uplds_size: function(srv: Psg_httpsrv;
    size: cuint64_t): cint; cdecl;
  sg_httpsrv_max_uplds_size: function(srv: Psg_httpsrv): cuint64_t; cdecl;
...
{$ENDIF}
    ...
    sg_httpsrv_set_max_payld_size := GetProcAddress(GSgLibHandle, 'sg_httpsrv_set_max_payld_size');
    sg_httpsrv_max_payld_size := GetProcAddress(GSgLibHandle, 'sg_httpsrv_max_payld_size');
    sg_httpsrv_set_max_uplds_size := GetProcAddress(GSgLibHandle, 'sg_httpsrv_set_max_uplds_size');
    sg_httpsrv_max_uplds_size := GetProcAddress(GSgLibHandle, 'sg_httpsrv_max_uplds_size');
...
begin
  ...
  try
    ...
    sg_httpsrv_set_max_payld_size := nil;
    sg_httpsrv_max_payld_size := nil;
    sg_httpsrv_set_max_uplds_size := nil;
    sg_httpsrv_max_uplds_size := nil;
