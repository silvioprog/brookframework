(*
  ConvUtils plugin.
  Copyright (C) 2012-2014 Silvio Clecio (adapted from the JEDI project).
...
resourcestring
  ...
  RsMathDomainError    = 'Domain check failure in ConvUtils';
...
begin
  if Err then
    raise Exception.CreateRes(@RsMathDomainError);
end;
