...
var
  ...
  SBrookNoLoggerServiceRegisteredError: string = 'No logger service registered.';
  SBrookLoggerServiceAlreadyRegisteredError: string = 'The logger service is already registered.';
